...
export function GuestQrCard({
  ...
  const [qrUrl, setQrUrl] = useState(`/guest/${propId}`);
  ...
  useEffect(() => {
    ...
    setQrUrl(`${window.location.origin}/guest/${propId}`);
  }, [propId]);
  ...
  return (
    <div className="w-full max-w-xl mx-auto my-6 flex flex-col gap-4 font-sans">
      ...
      <div className="print-hidden flex items-center justify-between p-3 bg-zinc-900 border border-zinc-800 rounded-xl">
        <span className="text-xs font-medium text-zinc-300">Cartel de Bienvenida y Portal AI</span>
      ...
      <div className="print-guest-card p-6 bg-zinc-950 border border-zinc-800 text-zinc-100 rounded-2xl shadow-xl print:border-none print:shadow-none print:p-2 print:text-black print:bg-white">
        ...
        <div className="flex flex-col items-center p-5 bg-zinc-900/70 border border-zinc-800 rounded-xl mb-5 text-center print:bg-zinc-50 print:border-zinc-300">
          <div className="p-2.5 bg-white rounded-xl shadow-md mb-2">
            <QRCodeSVG value={qrUrl} size={140} level="M" title={qrUrl} />
          </div>
          <p className="text-xs font-semibold text-zinc-200 print:text-zinc-800">
            Escanea para hablar con Elena o abrir el portal
          </p>
          <p className="mt-1 break-all font-mono text-[10px] text-zinc-500">{qrUrl}</p>
          <a
            href={qrUrl}
            target="_blank"
            rel="noreferrer"
            className="print-hidden inline-flex items-center gap-1 mt-1.5 text-[11px] text-emerald-400 hover:underline"
          >
        ...
        <div className="space-y-2 mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-white print:text-black">Anfitrión / co-host</p>
          ...
          >
            ...
            <div>
              ...
              {emergencyNumber !== "911" ? (
                <p className="text-[10px] text-zinc-500">Urgencias anfitrión: {emergencyNumber}</p>
              ) : null}
            </div>
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 pt-3 border-t border-zinc-800 text-xs print:border-zinc-300">
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-zinc-400 print:text-zinc-500 mt-1">Clave:</p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-1 text-[10px] text-zinc-400 print:text-zinc-500">Puerta:</p>
